...
Definition tm_mutind :=
  ...
  tm_ind' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25.

Scheme tm_rec' := Induction for tm Sort Set.

Definition tm_mutrec :=
  fun H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 =>
  tm_rec' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25.
...
Fixpoint size_tm (a1 : tm) {struct a1} : nat :=
  match a1 with
    ...
    | a_With A1 B1 => 1 + (size_tm A1) + (size_tm B1)
    | a_Pair a2 b1 => 1 + (size_tm a2) + (size_tm b1)
    | a_Prj1 a2 => 1 + (size_tm a2)
    | a_Prj2 a2 => 1 + (size_tm a2)
  end.
...
Inductive degree_tm_wrt_tm : nat -> tm -> Prop :=
  ...
  | degree_wrt_tm_a_With : forall n1 A1 B1,
    degree_tm_wrt_tm n1 A1 ->
    degree_tm_wrt_tm (S n1) B1 ->
    degree_tm_wrt_tm n1 (a_With A1 B1)
  | degree_wrt_tm_a_Pair : forall n1 a1 b1,
    degree_tm_wrt_tm n1 a1 ->
    degree_tm_wrt_tm n1 b1 ->
    degree_tm_wrt_tm n1 (a_Pair a1 b1)
  | degree_wrt_tm_a_Prj1 : forall n1 a1,
    degree_tm_wrt_tm n1 a1 ->
    degree_tm_wrt_tm n1 (a_Prj1 a1)
  | degree_wrt_tm_a_Prj2 : forall n1 a1,
    degree_tm_wrt_tm n1 a1 ->
    degree_tm_wrt_tm n1 (a_Prj2 a1).

Scheme degree_tm_wrt_tm_ind' := Induction for degree_tm_wrt_tm Sort Prop.

Definition degree_tm_wrt_tm_mutind :=
  fun H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 =>
  degree_tm_wrt_tm_ind' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25.
...
Inductive lc_set_tm : tm -> Set :=
  ...
  | lc_set_a_With : forall A1 B1,
    lc_set_tm A1 ->
    (forall x1 : tmvar, lc_set_tm (open_tm_wrt_tm B1 (a_Var_f x1))) ->
    lc_set_tm (a_With A1 B1)
  | lc_set_a_Pair : forall a1 b1,
    lc_set_tm a1 ->
    lc_set_tm b1 ->
    lc_set_tm (a_Pair a1 b1)
  | lc_set_a_Prj1 : forall a1,
    lc_set_tm a1 ->
    lc_set_tm (a_Prj1 a1)
  | lc_set_a_Prj2 : forall a1,
    lc_set_tm a1 ->
    lc_set_tm (a_Prj2 a1).
...
Definition lc_tm_mutind :=
  ...
  lc_tm_ind' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24.

Scheme lc_set_tm_ind' := Induction for lc_set_tm Sort Prop.

Definition lc_set_tm_mutind :=
  fun H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 =>
  lc_set_tm_ind' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24.

Scheme lc_set_tm_rec' := Induction for lc_set_tm Sort Set.

Definition lc_set_tm_mutrec :=
  fun H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 =>
  lc_set_tm_rec' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24.
...
Hint Extern 1 (lc_tm (a_With _ _)) =>
  let x1 := fresh in
  pick_fresh x1;
  apply (lc_a_With_exists x1) : core.
...
Lemma lc_body_a_With_2 :
forall A1 B1,
  lc_tm (a_With A1 B1) ->
  body_tm_wrt_tm B1.
Proof. Admitted.

Hint Resolve lc_body_a_With_2 : lngen.
...
Lemma subst_tm_tm_a_With :
forall x2 A1 B1 a1 x1,
  lc_tm a1 ->
  x2 `notin` fv_tm_tm a1 `union` fv_tm_tm B1 `union` singleton x1 ->
  subst_tm_tm a1 x1 (a_With A1 B1) = a_With (subst_tm_tm a1 x1 A1) (close_tm_wrt_tm x2 (subst_tm_tm a1 x1 (open_tm_wrt_tm B1 (a_Var_f x2)))).
Proof. Admitted.

Hint Resolve subst_tm_tm_a_With : lngen.
