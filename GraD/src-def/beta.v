...
Axiom invert_Beta_a_With1 : forall {A B A0 B0 }, Beta (a_With A B) (a_With A0 B0) -> Beta A A0.
Axiom invert_Beta_a_With2 : forall {A B A0 B0 }, Beta (a_With A B) (a_With A0 B0) -> 
       forall x, x `notin` fv_tm_tm B \u fv_tm_tm B0 ->                                             
                 Beta (open_tm_wrt_tm B (a_Var_f x)) (open_tm_wrt_tm B0 (a_Var_f x)).
...
Inductive consistent : tm -> tm -> Prop :=
  ...
  | con_With : forall A B A' B', consistent (a_With A B) (a_With A' B')
  ...
  | con_tensor  : forall A B A' B', consistent (a_Tensor A B) (a_Tensor A' B')
  | con_pair  : forall A B A' B', consistent (a_Pair A B) (a_Pair A' B')
  | con_inj1 : forall a a', consistent (a_Inj1 a) (a_Inj1 a')
  | con_inj2 : forall a a', consistent (a_Inj2 a) (a_Inj2 a')
  | con_prj1 : forall a a', consistent (a_Prj1 a) (a_Prj1 a')
  | con_prj2 : forall a a', consistent (a_Prj2 a) (a_Prj2 a')
...
| ty_With : forall A B, ty (a_With A B)
...
Inductive value : tm -> Prop :=
  ...
  | val_pair : forall a b, value (a_Pair a b)
.
