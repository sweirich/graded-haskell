...
forall s1, 1 <= size_sort s1.
Proof.
pose proof size_sort_min_mutual as H; intuition eauto.
Qed.
...
forall psi1, 1 <= size_grade psi1.
Proof.
pose proof size_grade_min_mutual as H; intuition eauto.
Qed.
...
try first [apply lc_set_tm_of_lc_tm
 | apply lc_set_grade_of_lc_grade
 | apply lc_set_sort_of_lc_sort];
